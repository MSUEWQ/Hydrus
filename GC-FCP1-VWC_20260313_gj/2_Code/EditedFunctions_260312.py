...
class Model:
    ...
    def add_profile_modified(self, profile, qtop=None):
        """
    ...
    def add_material(self, material):
        ...
        if material.columns.size != \
                self.get_empty_material_df_modified().columns.size:
    ...
    def add_time_info(self, tinit=0, tmax=1, dt=0.01, dtmin=1e-5, dtmax=5,
        ...
        self.time_info = {"dt": dt, "dtMin": dtmin, "dtMax": dtmax,
                          ...
                          "lPrintD": print_times, "nPrintSteps": 1,
        ...
        if from_atmo:
            ...
            if print_times:
                ...
                if printinit == tinit:
                    ...
                    self.times = times
                self.time_info["MPL"] = 1 #len(self.times)
            else:
    ...
    def get_empty_material_df_modified(self, n=1):
        """
